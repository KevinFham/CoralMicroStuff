...
[[noreturn]] void print_task(void* param) {
  while (true){
...
void Main() {
  //Original: coralmicro/examples/file_read_write.cc

  printf("Begin filesystem example\r\n");
  // Turn on Status LED to show the board is on.
  LedSet(Led::kStatus, true);
  //xTaskCreate(&print_task, "print_root_task", configMINIMAL_STACK_SIZE, nullptr, coralmicro::kAppTaskPriority, nullptr);
  while (true){
    PrintFilesystemContents();
  }
}
