/*
 ...
 - Upload this .ino file to the Coral Micro using Arduino
 - Run the corresponding detect_objects example with the flashtool in the git project https://github.com/google-coral/coralmicro
   - Use the --noprogram tag with the flashtool ('python3 scripts/flashtool.py -e detect_objects --noprogram')
*/
